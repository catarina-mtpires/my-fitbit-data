...
# Missing
ORIG_STRESS_SCORE_DIR = ORIG_STRESS_DIR + "stress_score/Stress Score.csv"
...
ORIG_SLEEP_DIR = ORIG_SLEEP_DATA_DIR + "sleep/sleep-*.json"
SLEEP_DIR = NEW_SLEEP_DIR + "sleep_data.csv"

ORIG_TIME_IN_HR_ZONES_DIR = ORIG_PH_DIR + "time_in_heart_rate_zones/time_in_heart_rate_zones-*.json"
TIME_IN_HR_ZONES_DIR = NEW_PH_DIR + "time_in_heart_rate_zones.csv"

ORIG_AZM_DIR = ORIG_PH_DIR + "active_minutes/active_zone_minutes/Active Zone Minutes - *.csv"
AZM_DIR = NEW_PH_DIR + "active_zone_minutes.csv"

ORIG_AZM_LIGHT_DIR = ORIG_PH_DIR + "active_minutes/lightly_active_minutes/lightly_active_minutes-*.json"
AZM_LIGHT_DIR = NEW_PH_DIR + "lightly_active_minutes.csv"

ORIG_AZM_MODERATE_DIR = ORIG_PH_DIR + "active_minutes/moderately_active_minutes/moderately_active_minutes-*.json"
AZM_MODERATE_DIR = NEW_PH_DIR + "moderately_active_minutes.csv"

ORIG_AZM_SEDENTARY_DIR = ORIG_PH_DIR + "active_minutes/sedentary_minutes/sedentary_minutes-*.json"
AZM_SEDENTARY_DIR = NEW_PH_DIR + "sedentary_minutes.csv"

ORIG_AZM_VERY_ACTIVE_DIR = ORIG_PH_DIR + "active_minutes/very_active_minutes/very_active_minutes-*.json"
AZM_VERY_ACTIVE_DIR = NEW_PH_DIR + "very_active_minutes.csv"

# Recorded activity and signals
ORIG_EXERCISE_DIR = ORIG_PH_DIR + "exercise/exercise-*.json"
EXERCISE_DIR = NEW_PH_DIR + "exercise_data.csv"

ORIG_SNORE_DIR = ORIG_SLEEP_DATA_DIR + "snore/Snore Details - *.csv"
SNORE_DIR = NEW_SLEEP_DIR + "snore_data.csv"

ORIG_EDA_DIR = ORIG_STRESS_DIR + "eda/mindfulness_eda_data_sessions.csv"
